...
- Следующий шаг R12.2: нормализовать совместное поведение правого server sticky widget и DonationAlerts, проверить visibility на desktop/mobile и убедиться, что немодальные виджеты не перекрывают modal overlay.
