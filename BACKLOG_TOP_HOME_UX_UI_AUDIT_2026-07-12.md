...
| R16 | Готово локально | Полный regression, итоговая документация, PR template и безопасный rollout/rollback готовы; push/draft PR ожидают установки и авторизации `gh` | R15 |
