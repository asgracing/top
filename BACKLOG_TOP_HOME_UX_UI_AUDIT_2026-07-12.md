...
- R12.2 в работе: добавлен единый компонент координации floating widgets. Server sticky скрыт ниже 1280 px, DonationAlerts ниже 761 px; в диапазоне 1280–1360 px виджеты разведены по разным сторонам. При открытой модалке оба немодальных виджета скрываются и перестают принимать события. Следующая проверка R12.2 — визуальная верификация desktop/mobile и очистка дублирующих legacy media rules.
