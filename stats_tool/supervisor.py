...
ENV_SERVER_STATUS_POLL_INTERVAL_SECONDS = "ACC_SERVER_STATUS_WATCH_INTERVAL_SECONDS"
...
def run_server_status_refresh() -> None:
...
def main():
    ...
    status_poll_interval = env_int(ENV_SERVER_STATUS_POLL_INTERVAL_SECONDS, 600)
    ...
    try:
        while True:
            ...
            try:
                ...
                if status_poll_interval > 0 and now - last_status_refresh_at >= status_poll_interval:
                    run_server_status_refresh()
                    last_status_refresh_at = now
