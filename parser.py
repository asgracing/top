...
def update_driver_day_best_lap(daily_stats, player_id, display_name, best_lap, track_name):
...
def add_driver_day_result(daily_stats, player_id, display_name, position, gained_points, best_lap, track_name):
    if not player_id:
        return
    ...
    update_driver_day_best_lap(daily_stats, player_id, display_name, best_lap, track_name)
...
def update_daily_best_lap(daily_stats, player_id, display_name, best_lap, track_name, session_type):
    if best_lap is None:
        return
...
def update_driver_best_lap(driver_stats, best_lap, track_name, session_type, file_modified):
    if best_lap is None:
        return
...
def git_publish_if_needed(changed_files):
    ...
    add_result = run_git(["add"] + changed_files)
