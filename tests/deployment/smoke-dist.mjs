...
const checks = ["/", "/account/", "/account/settings/", "/teams/", "/teams/app.js", "/races/", "/driver/", "/cars/", "/fun-stats/", "/community/", "/news/", "/bans/", "/app.js", "/src/entrypoints/home.js", "/asset-manifest.json", "/build-meta.json"];
const failures = [];
try {
