...
for (const [page, [htmlPath, entrySrc]] of Object.entries(pageEntrypoints)) {
  ...
  const sectionsHref = page === "home" ? "./styles/components/sections.css?v=20260802statsnav1" : "../styles/components/sections.css?v=20260715r11sections1";
  ...
  for (const href of [
    ...
    page === "home"
      ? "./styles/responsive.css?v=20260802statsnav1"
