...
if (!js.includes('from "./src/pages/races/model.js"') || js.includes("const racesColumns = [") || js.includes("function filterRaces(") || js.includes("const isV2PagedArchive")) failures.push("Races table and pagination model must live outside app.js");
