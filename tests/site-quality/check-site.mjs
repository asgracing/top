...
if (!html.includes('./styles/components/hero-server-summary.css?v=20260715r12grid4')) failures.push("Home must load the extracted hero server summary component after styles.css");
...
if (!html.includes('./styles/components/hero-layout.css?v=20260715r12mobile3') || !heroLayoutCss.includes("@media (min-width: 1181px)")) failures.push("Home must load the extracted responsive hero layout component");
