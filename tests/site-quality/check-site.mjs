...
if (!html.includes('./styles/components/hero-layout.css?v=20260728tabletflow1') || !heroLayoutCss.includes("@media (min-width: 1181px)")) failures.push("Home must load the extracted responsive hero layout component");
