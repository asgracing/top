...
if (!html.includes('./styles/components/hero-server-summary.css?v=20260715r12grid3')) failures.push("Home must load the extracted hero server summary component after styles.css");
...
if (!html.includes('./styles/components/hero-layout.css?v=20260715r12mobile2') || !heroLayoutCss.includes("@media (min-width: 1181px)")) failures.push("Home must load the extracted responsive hero layout component");
if (!heroLayoutCss.includes('"races"') || !heroLayoutCss.includes("@media (max-width: 640px)") || !heroLayoutCss.includes("grid-auto-rows: auto;")) failures.push("Mobile hero actions must reserve a separate row for every button and widget");
