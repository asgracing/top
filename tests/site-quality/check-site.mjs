...
if (!js.includes('from "./src/pages/races/model.js"') || js.includes("const racesColumns = [") || js.includes("function filterRaces(")) failures.push("Races table model must live outside app.js");
