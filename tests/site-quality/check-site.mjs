...
if (!html.includes('./styles/components/hero-server-summary.css?v=20260715r12grid2')) failures.push("Home must load the extracted hero server summary component after styles.css");
...
if (!heroServerSummaryCss.includes("grid-template-rows: repeat(2, 58px);") || !heroServerSummaryCss.includes("grid-column: 1 / -1;") || !heroServerSummaryCss.includes("grid-template-columns: repeat(2, minmax(0, 1fr));")) failures.push("Hero mini stats must preserve the explicit desktop 2x2 grid");
