...
if (!js.includes("const pageInitializationErrorHandlers = Object.freeze({") || !js.includes("function handleCurrentPageInitializationError(error)")) failures.push("Page initialization errors must use the explicit handler registry");
